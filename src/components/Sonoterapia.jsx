...
const Sonoterapia = ({ onVolver }) => {
  ...
  return (
    <div className="sonoterapia-moderna">
      ...
      {/* Contenido principal */}
      <div className="sonoterapia-contenido">
        ...
        <div className="controles-principales">
          <div className="busqueda-container">
            ...
            <input
              type="text"
              placeholder="Buscar frecuencias, beneficios o categorías..."
              value={sonoterapiaState.busqueda}
              onChange={(e) => updateSonoterapiaState({ busqueda: e.target.value })}
...
const SonoterapiaConProvider = ({ onVolver }) => {
  return (
    <SonoterapiaProvider>
      <Sonoterapia onVolver={onVolver} />
    </SonoterapiaProvider>
  );
};
