...
import { 
  ...
  Search, Filter, Grid, List, Calendar, Clock, User, Tag, Eye, Bookmark,
  Maximize2, X, Settings, RotateCcw, Headphones, Youtube, Facebook, 
  Instagram, MessageCircle, Send, Star, TrendingUp, Award, Users
} from 'lucide-react';
      ...
      <div className="blog-controles">
        <div className="busqueda-container">
          ...
          <input
            ...
            value={blogPodcastState.busqueda}
            onChange={(e) => updateBlogPodcastState({ busqueda: e.target.value })}
    ...
    <div className="podcast-section">
      ...
      <div className="podcast-controles">
        <div className="busqueda-container">
          ...
          <input
            type="text"
            placeholder="Buscar episodios por título, descripción o tags..."
            value={blogPodcastState.busqueda}
            onChange={(e) => updateBlogPodcastState({ busqueda: e.target.value })}
            className="busqueda-input"
          />
